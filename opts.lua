...
function M.parse(arg)
   ...
   cmd:option('-dataset',    'imagenet', 'Options: imagenet | cifar10 | cifar100 | svhn')
   ...
   cmd:option('-save',            '/media/jiaren/snapshots', 'Directory in which to save checkpoints')
   ...
   ---------- Model options ----------------------------------
   cmd:option('-netType',      'CoPaNet', 'Options: resnet | preresnet')
